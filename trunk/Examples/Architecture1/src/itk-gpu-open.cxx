...
int main(int argc, char **argv) {
  ...
  typedef itk::CudaGrayscaleMorphologicalOpeningImageFilter<InputImageType, OutputImageType, StructuringElementType> FilterType;
