...
// // Pointer to 3D Texture
//     texture<K, 3> texRef3DKernel;
//     texture<T, 3> texRef3DInput;
...
// Pointer to 2D Texture
//     texture<K, 2> texRef2DKernel;
//     texture<T, 2> texRef2DInput;
...
template void CudaGrayscaleErodeImageFilterKernelFunction<THISTYPE, THISTYPE, KTYPE>(const THISTYPE * input, THISTYPE * output, 
										     const unsigned long * iDim, const unsigned long * r,
